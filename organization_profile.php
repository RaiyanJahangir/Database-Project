  ...
  <div class="profile-nav col-md-3">
      <div class="panel">
          <div class="user-heading round">
              ...
              <h1><?php echo strtoupper($_SESSION['oname']); ?></h1>
              <p><?php echo $_SESSION['oemail']; 
              ?></p>
          </div>
  ...
  <div class="profile-info col-md-9">
      <div class="panel">
          ...
          <div class="panel-body bio-graph-info">
              ...
              <div class="row">
                  <div class="bio-row">
                      <p><span>Name </span>: <?php echo strtoupper($_SESSION['oname']); ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Email </span>: <?php echo $_SESSION['oemail']; ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>City </span>: <?php echo $_SESSION['ocity']; ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Street</span>: <?php echo $_SESSION['ostreet']; ?></p>
                  </div>
                  <!--<div class="bio-row">
                      <p><span>Age </span>: <?php //echo $_SESSION['page']; ?></p>
                  </div>-->
                  <div class="bio-row">
                      <p><span>Postal</span>: <?php echo $_SESSION['opostal']; ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Branch </span>: <?php echo $_SESSION['obranch']; ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>No. of Purchase </span>: <?php echo $_SESSION['opurchase']; ?></p>
                  </div>
