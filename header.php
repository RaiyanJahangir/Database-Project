            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="content style text-center">
                        <h2 class="text-white text-bold mb-2">More ways you can support us</h2>
                        <p class="tag-text mb-5">All type of blood are needed to help patients...</p>
                        <a href="#" class="btn btn-main btn-white">Donate Money</a>
                    </div>
                    <!-- Slide Content End -->
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="cta-block">
                    <div class="emmergency item">
                        ...
                        <p>Emergency cases will be given more priority.</p>
                    </div>
                    <div class="top-doctor item">
                        <i class="fa fa-stethoscope"></i>
                        <h2>24 Hour Service</h2>
                        <p>Our 24 hours online service helps you find emergency blood through nearest blood bank and hospital. If you become a
                        donor you can safely donate bloods and also join many other blood donation campaigns.</p>
