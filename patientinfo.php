            ...
            <div class="col-md-12" >
                <div class="contact-form">
                    <div class="section-title">
                        <h3 style="text-align: center;">Patient<span>Information Form</span></h3>
                    </div>
                    <br>
                    <br>
                    <!-- contact form start -->
                    <form action="patient-request.php" class="row" method="post">
                        <!-- name -->
                        <div class="col-md-12">
                    ...
                    <div class="form-group col-lg-12 mx-auto mb-0" style="padding-top: 5%;">
                        <a href="#" class="btn btn-primary btn-block py-2" style="background-color:#fa4141;">
                            ...
                            <input style="color:white; background-color: #fa4141; border: 0ch;" class="button" type="submit" name="save" value="Submit">
                        </a>
                    </div>
                    </form>
                    <!-- Already Registered -->
